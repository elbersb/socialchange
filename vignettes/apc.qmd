...
For research purposes, this package also implements some methods on APC analysis. We use the `gss_homosex` dataset for these examples. For a CR-IC decomposition of the same dataset comparing intracohort change and cohort replacement, see the [GSS homosexuality vignette](gss_homosexuality.html).
