...
This short reversal does not establish a new sociological period. It contains only two transitions, and its boundary follows the observed 2021 peak. The 2021 round had no in-person interviews and later rounds used mixed modes. We therefore also compare 2022 and 2024, which included the same four mode categories.
...
Acceptance declined within every interview mode. Holding the mode distribution at its 2022 composition increases the estimated decline from 0.062 to 0.082. Changing mode composition therefore does not explain the 2022--2024 decline. Mode is a measurement condition rather than a demographic event, so it is not passed to the decomposition as a population cell.
