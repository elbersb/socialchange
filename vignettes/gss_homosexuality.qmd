...
The female and male intervals overlap for the total change and for every component except net in-migration, so the apparent difference in intraindividual change, mortality, and coming-of-age is within sampling noise rather than a distinguishable difference. Net in-migration is the exception (the component for women being clearly more negative).
