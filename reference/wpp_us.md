...
World Population Prospects (WPP) 2024, for every year from 1973 to 2024
(the span of the
...
needed). Prepared from data distributed by the
[wpp2024](https://github.com/PPgp/wpp2024) project.
...
A data.table with 7,488 rows and 4 variables:

- period:

  Year (numeric), 1973–2024.
